...
This repository documents the entire development process of the game LoopBot, inspired by LightBot, built using HTML, CSS, and JavaScript. I continued developing it independently on my own initiative after submitting the previous version to my instructor, Igor Knop, at the Federal University of Juiz de Fora (1st semester – Web Development course).
